...
{\small (As of 2024-04-09)}

\section{\mysidestyle Contact information}
Carmichael, CA 95608 USA \\
\href{mailto:butterflyology@gmail.com}{Contact me via email}\\
...
\section{\mysidestyle Employment}
 ...
 {\bf Lead Data Scientist}, 
Nestl\'{e}-Purina \\
Carmichael, CA, 2022-Present.
 
{\bf Lead Data Scientist}, 
Bayer \\
Carmichael, CA, 2018-2022.

{\bf Data Scientist}, 
Monsanto Company \\
Woodland, CA, 2017-2018.
...
{\bf Hamm, C.A}. 2017. Chromosome Number of the Monarch Butterfly, {\em Danaus plexippus} (Linnaeus 1758) and the Danainae. \href{http://biorxiv.org/content/early/2017/02/08/107144}{BioR$\chi$iv}.

Marion, Z.H. and {\bf C.A. Hamm}. 2017. A hierarchical Bayesian approach to estimate endosymbiont infection rates. \href{http://biorxiv.org/content/early/2017/01/21/102020}{BioR$\chi$iv}.

Bell, K.L., {\bf C.A. Hamm}, A.M. Shapiro and C.C. Nice. 2017. Sympatric, temporally isolated populations of the Pine White butterfly {\em Neophasia menapia}, are morphologically and genetically differentiated. \href{https://doi.org/10.1371/journal.pone.0176989}{\em PLoS ONE} 12(5): e0176989.
...
{\bf Hamm C.A.} and J.A. Fordyce. 2016. Selaginella and the satyr: {\em Euptychia westwoodi} oviposition preference and performance. \href{http://jinsectscience.oxfordjournals.org/content/16/1/39}{\em Journal of Insect Science} 16: 39; 1-4.

Fordyce J.A., C.C. Nice, {\bf C.A. Hamm} and M.L. Forister. 2016. Quantifying diet breadth through ordination of host associations. \href{http://onlinelibrary.wiley.com/doi/10.1890/15-0093.1/abstract}{\em Ecology} 97: 842-849.
...
{\bf Loewy Family Foundation Fellowship} (\$10,000) Mohonk Preserve. Award to conduct standardized butterfly monitoring of fruit-feeding butterflies, 2016.
...
\item ``Transformers for Time Series Analysis" World Conference on Data Science \& Statistics, June 2024.

\item ``Adventure thru Sponsor Space - The Legacy of Monsanto and Disney" Pixar, September 2019.

\item ``Upskilling the Community - Data Fluency at Scale'' 2019 Disney Data \& Analytics Conference, August 2019.

\item ``Building Data Fluency at Monsanto'' Software Carpentry Mini-Symposium at {\bf T}echnical {\bf C}ommunity {\bf M}onsanto, 2018 Annual Meeting, June 2018.

\item ``How to design a good experiment." UC Davis {\bf D}ata {\bf I}ntensive {\bf B}iology {\bf S}ummer {\bf I}nstitute, June 2017. 
...
\item ``Software Carpentry at Monsanto'' at {\bf T}echnical {\bf C}ommunity {\bf M}onsanto, 2018 Annual Meeting, June 2018.
...
{\bf Certified Instructor Trainer:} Software Carpentry Foundation.
\\Workshops taught: 
\begin{itemize}

\item The Pennsylvania State University, April 2024.

\item Columbia University, January 2020.

\item Software Carpentry Foundation, December 2018.

\item Georgia Institute of Technology, November 2018.

\item The Jackson Laboratory, June 2018.

\item Monsanto Company, May 2018.

\item Monsanto Company, October 2017.

\item Berkeley Institute for Data Science \& Lawrence Berkeley Laboratories, August 2017.
...
\item Library Carpentry, \codechunk{bash} Georgia Tech. May 2023.

\item Data Carpentry, \codechunk{python}, Carnegie Mellon University. March 2019.

\item Data Carpentry, \codechunk{R}, University of Southern California. January 2019.

\item Software Carpentry , \codechunk{Python}, Stanford University. August 2018.

\item Data Carpentry, \codechunk{Genomics}, Tucson Plant Breeding Institute. January 2018.

\item Data Carpentry, \codechunk{R}, Grand Valley State University. December 2017.

\item Software Carpentry, \codechunk{R}, Monsanto Company. December 2017.

\item Data Carpentry, \codechunk{Genomics}, Rutgers University. December 2017.

\item Data Carpentry, \codechunk{R}, Federal Reserve Board of Washington D.C. June 2017.

\item Data Carpentry, \codechunk{Genomics}, California State University Monterey Bay. March 2017.
...
\item Data Carpentry, \codechunk{R}, Stony Brook University. August 2016.
...
\item Data Carpentry, \codechunk{R}, University of Notre Dame. March 2016.

\item Software Carpentry, \codechunk{R}, University of California San Francisco. November 2015.

\item Data Carpentry, \codechunk{Genomics}, Kellogg Biological Station. August 2015.
...
{\bf Amazon Web Services Machine Learning Pipeline}. Four-day workshop on Machine Learning using AWS and SageMaker resources.

{\bf Software Carpentry Instructor Trainer}. Certification procedure to train and certify instructors for Software Carpentry. February 2017.
